...
///
/// ```
/// use wham_elements::form::FormPath;
///
...
///
/// ```
/// use wham_elements::form::{FormSchema, FieldType};
...
impl FormSchema {
    ...
    /// # Example
    /// ```
    /// use wham_elements::form::{FormSchema, FieldType, AutocompleteHint};
...
///
/// ```
/// use wham_elements::form::{Form, FormSchema, FieldType, FieldValue, FormPath};
///
